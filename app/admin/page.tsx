...
import ActiveUsersTrendCard from '../components/admin/ActiveUsersTrendCard';
...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white">
      {/* 🔥 TOP HEADER — similar to app/page.tsx with Back + clickable logo */}
      <header className="sticky top-0 z-20 w-full py-4 bg-black/80 backdrop-blur border-b border-white/10 shadow-md flex items-center justify-between px-4">
        ...
        <Link
          href="/"
          className="text-3xl font-black flex items-center justify-center leading-none hover:opacity-80 transition"
        >
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto p-4 flex flex-col gap-6">
        {/* ADMIN TITLE */}
        <h2 className="text-2xl font-bold text-lime-400 text-center tracking-tight">
          Admin Dashboard
        </h2>
